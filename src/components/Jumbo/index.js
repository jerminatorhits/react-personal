			  ...
			  <Grid>
				  <Row className="show-grid">
				    <Col md={6} mdPush={6}>
				    	...
				    	<p>I am a software engineer who loves solving problems from finding the fastest routes to optimizing credit card points. I have a Bachelor's Degree from UC San Diego and have performed software consulting at <a href="https://8thlight.com/">8th Light</a>. Among watching Netflix and running, I enjoy recording music in my home studio and traveling the world.</p>
				    </Col>
				    <Col md={6} mdPull={6}>
